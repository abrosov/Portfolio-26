...
- **Responsive**: the grid halves as the window narrows — 12 columns on desktop, 6 at 1180px and under,
  2 below 768px — driven by `--grid-columns` in `tokens.css`, with the gutter at 32px dropping to
  28px on mobile. Column counts and stepping follow bndigital.co. At 1180px and under the case pages' pinned
